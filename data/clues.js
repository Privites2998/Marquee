/* Now Playing CLUE LAYER for the shows database.
   Maps a show id (data/shows.js) to its Now Playing { blurb, clues }.
   blurb = a teasing one-liner; clues = 5 hints, most-vague to near-giveaway.
   Hand-maintained. tools/build-nowplaying.js merges this with data/shows.js to
   regenerate games/nowplaying/shows.js. Add a new show's clues here, then rebuild.
*/
window.MarqueeClues = {
  "hamilton": {
