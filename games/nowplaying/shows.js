...
window.NowPlayingPuzzles = [
  ...
  {
    id: 3, name: "The Phantom of the Opera", aliases: ["phantom of the opera","the phantom of the opera","phantom"],
  ...
  {
    id: 4, name: "Les Misérables", aliases: ["les miserables","les mis","les miz"],
  ...
  {
    id: 6, name: "Dear Evan Hansen", aliases: ["dear evan hansen","deh"],
  ...
  {
    id: 7, name: "The Book of Mormon", aliases: ["the book of mormon","book of mormon"],
  ...
  {
    id: 9, name: "Into the Woods", aliases: ["into the woods"],
  ...
  {
    id: 10, name: "Sweeney Todd", aliases: ["sweeney todd","sweeney todd: the demon barber of fleet street"],
  ...
  {
    id: 11, name: "Chicago", aliases: ["chicago"],
  ...
  {
    id: 13, name: "The Lion King", aliases: ["the lion king","lion king"],
  ...
  {
    id: 14, name: "Cabaret", aliases: ["cabaret"],
  ...
  {
    id: 15, name: "West Side Story", aliases: ["west side story"],
  ...
  {
    id: 16, name: "Fiddler on the Roof", aliases: ["fiddler on the roof","fiddler"],
  ...
  {
    id: 17, name: "A Chorus Line", aliases: ["a chorus line","chorus line"],
  ...
  {
    id: 18, name: "The Sound of Music", aliases: ["the sound of music","sound of music"],
  ...
  {
    id: 19, name: "Oklahoma!", aliases: ["oklahoma","oklahoma!"],
  ...
  {
    id: 20, name: "Guys and Dolls", aliases: ["guys and dolls"],
  ...
  {
    id: 21, name: "Annie", aliases: ["annie"],
  ...
  {
    id: 22, name: "In the Heights", aliases: ["in the heights"],
  ...
  {
    id: 23, name: "Hairspray", aliases: ["hairspray"],
  ...
  {
    id: 24, name: "Mamma Mia!", aliases: ["mamma mia","mamma mia!"],
  ...
  {
    id: 25, name: "Six", aliases: ["six","six the musical"],
  ...
  {
    id: 26, name: "Newsies", aliases: ["newsies"],
  ...
  {
    id: 27, name: "Avenue Q", aliases: ["avenue q"],
  ...
  {
    id: 28, name: "Jesus Christ Superstar", aliases: ["jesus christ superstar","superstar"],
  ...
  {
    id: 29, name: "Evita", aliases: ["evita"],
  ...
  {
    id: 30, name: "Funny Girl", aliases: ["funny girl"],
  ...
  {
    id: 31, name: "Gypsy", aliases: ["gypsy"],
    blurb: "The ultimate stage mother pushes her daughters toward stardom as vaudeville fades.",
    clues: [
      "A 1959 musical with a book by Arthur Laurents and early lyrics by Stephen Sondheim.",
      "Based on the memoirs of a famous striptease artist.",
      "Often called one of the greatest American musicals; its lead is a legendary belter role.",
      "The relentless mother is named Rose; her shy daughter becomes Gypsy Rose Lee.",
      "Rose's eleven-o'clock breakdown is 'Rose's Turn,' after 'Everything's Coming Up Roses.'"
    ]
  },
  {
    id: 32, name: "Pippin", aliases: ["pippin"],
    blurb: "A restless young prince hunts for meaning, egged on by a sly troupe of players.",
    clues: [
      "A 1972 musical with songs by Stephen Schwartz, directed and choreographed by Bob Fosse.",
      "A theatrical troupe led by a 'Leading Player' narrates and manipulates the story.",
      "Loosely inspired by the son of Charlemagne.",
      "Ben Vereen won a Tony as the Leading Player; the prince seeks his 'Corner of the Sky.'",
      "The troupe lures the audience in with the opening number 'Magic to Do.'"
    ]
  },
  {
    id: 33, name: "Come From Away", aliases: ["come from away"],
  ...
  {
    id: 34, name: "Jersey Boys", aliases: ["jersey boys"],
